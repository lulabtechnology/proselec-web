...
export default function ContactoPage() {
  const wa = waLink(
    ...
    "Hola, quiero cotizar un proyecto con PROSELEC, S.A."
  );

  const email = CONTACT.emails[0]; // ✅ antes estabas usando CONTACT.email (no existe)
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12">
      ...
      <p className="mt-2 text-slate-600">
        Escríbenos por WhatsApp o llámanos. También puedes visitarnos.
      </p>
        ...
        <section className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-3 text-slate-700">
            <div>
              ...
              <a className="text-sm text-slate-700 underline" href={telLink(CONTACT.phoneE164)}>
